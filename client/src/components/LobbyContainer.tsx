...
function LobbyContainer({ children }: LobbyContainerProps) {
  return (
    <div className=" flex flex-col mb-4  items-center mt-8 w-full max-w-[850px] min-h-[400px] text-white bg-black">
      ...
      <div className="mt-3 p-3 rounded-2xl cursor-pointer bg-white flex items-center justify-center duration-300 ease-in-out hover:-translate-y-1 hover:scale-110">
